            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1">
                        <li class="breadcrumb-item"><a href="{{ route('adminProduct') }}" class="text-decoration-none">Products</a></li>
                        ...
                        <div class="card shadow-sm border-0 rounded-4 p-3 mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">This will be the web address: surjosports.com/product/<strong>slug</strong></small>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-bold">Description</label>
                                    <textarea name="description" rows="5" class="form-control" placeholder="Write premium details about the fabric, fit, and quality...">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="price" class="form-control form-control-lg" placeholder="0.00" value="{{ old('price') }}">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label fw-bold">Old Price (TK) <span class="text-muted small">(Optional)</span></label>
                                        <input type="number" name="old_price" class="form-control form-control-lg" placeholder="0.00" value="{{ old('old_price') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow-sm border-0 rounded-4 p-3">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="image" class="form-control" onchange="previewMainImage(this)">
                                    <div id="main-preview" class="mt-2 text-center border rounded-3 p-2 d-none">
                                        <img src="" id="main-img-tag" style="max-width: 100%; height: 150px; object-fit: contain;">
                                    </div>
                                </div>
