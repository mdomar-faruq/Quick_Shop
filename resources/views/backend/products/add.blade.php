            ...
            <div class="col-12">
                <form action="{{ route('adminProductStore') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-8">
                            <div class="card shadow-sm border-0 rounded-4 p-3 mb-4 bg-body-tertiary">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="slug" id="slug"
                                            class="form-control bg-body-tertiary @error('slug') is-invalid @enderror"
                            ...
                            <div class="card shadow-sm border-0 rounded-4 p-3 bg-body-tertiary">
                                <div class="card-body">
